...
public class ProductClient {
    ...
    private final RestTemplate restTemplate;//pristapuvame do resurs sto ni sedi na nekoja porta
    private final String serverUrl;

    public ProductClient(@Value("${app.product-catalog.url}") String serverUrl) {//chitame od app properties
